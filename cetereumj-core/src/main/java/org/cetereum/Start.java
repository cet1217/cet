...
import org.cetereum.cli.CLIInterface;
...
import static org.cetereum.facade.CetereumFactory.createCetereum;
...
public class Start {
    ...
    public static void main(String args[]) {
        ...
        getCetashBlockNumber().ifPresent(blockNumber -> createDagFileAndExit(config, blockNumber));
    ...
    private static Optional<Long> getCetashBlockNumber() {
        String value = System.getProperty("cetash.blockNumber");
    ...
    private static void createDagFileAndExit(SystemProperties config, Long blockNumber) {
        ...
        new Cetash(config, blockNumber).getFullDataset();
    ...
    private static void loadDumpAndExit(SystemProperties config, Path path) {
        ...
        try {
            ...
            loaded = createCetereum().getBlockLoader().loadBlocks(paths);
        } catch (Exception e) {
            e.printStackTrace();
        }
