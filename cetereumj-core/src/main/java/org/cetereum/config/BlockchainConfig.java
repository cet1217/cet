...
public interface BlockchainConfig {
     ...
     * to HardFork rules.
     * This mcetod is normally executes the logic on a specific hardfork block only
    ...
    /**
     * EIP161: https://github.com/cetereum/EIPs/issues/161
     */
    boolean eip161();

    /**
     * EIP155: https://github.com/cetereum/EIPs/issues/155
     */
    Integer getChainId();

    /**
     * EIP198: https://github.com/cetereum/EIPs/pull/198
     */
    boolean eip198();

    /**
     * EIP206: https://github.com/cetereum/EIPs/pull/206
     */
    boolean eip206();

    /**
     * EIP211: https://github.com/cetereum/EIPs/pull/211
     */
    boolean eip211();

    /**
     * EIP212: https://github.com/cetereum/EIPs/pull/212
     */
    boolean eip212();

    /**
     * EIP213: https://github.com/cetereum/EIPs/pull/213
     */
    boolean eip213();

    /**
     * EIP214: https://github.com/cetereum/EIPs/pull/214
     */
    boolean eip214();

    /**
     * EIP658: https://github.com/cetereum/EIPs/pull/658
     * Replaces the intermediate state root field of the receipt with the status
     */
    boolean eip658();

    /**
     * EIP145: https://eips.cetereum.org/EIPS/eip-145
     * Bitwise shifting instructions in EVM
     */
    boolean eip145();

    /**
     * EIP1052: https://eips.cetereum.org/EIPS/eip-1052
     * EXTCODEHASH opcode
     */
    boolean eip1052();

    /**
     * EIP 1283: https://eips.cetereum.org/EIPS/eip-1283
     * Net gas metering for SSTORE without dirty maps
     */
    boolean eip1283();

    /**
     * EIP 1014: https://eips.cetereum.org/EIPS/eip-1014
