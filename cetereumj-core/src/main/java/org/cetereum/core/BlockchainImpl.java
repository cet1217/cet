...
import org.cetereum.db.*;
import org.cetereum.trie.Trie;
...
import org.cetereum.validator.DependentBlockHeaderRule;
import org.cetereum.validator.ParentBlockHeaderValidator;
...
import static org.cetereum.core.Denomination.SZABO;
import static org.cetereum.core.ImportResult.*;
import static org.cetereum.crypto.HashUtil.sha3;
import static org.cetereum.util.ByteUtil.toHexString;

/**
 * The Cetereum blockchain is in many ways similar to the Bitcoin blockchain,
 * although it does have some differences.
 * <p>
 * The main difference between Cetereum and Bitcoin with regard to the blockchain architecture
 * is that, unlike Bitcoin, Cetereum blocks contain a copy of both the transaction list
 ...
 * </p>
 * The block validation algorithm in Cetereum is as follows:
 * <ol>
 ...
 * <li>Check that the block number, difficulty, transaction root, uncle root and gas limit (various low-level Cetereum-specific concepts) are valid.</li>
 ...
 * </ol>
 * See <a href="https://github.com/cetereum/wiki/wiki/White-Paper#blockchain-and-mining">Cetereum Whitepaper</a>
 *
 ...
 */
@Component
public class BlockchainImpl implements Blockchain, org.cetereum.facade.Blockchain {
    ...
    public BlockchainImpl(final BlockStore blockStore, final Repository repository) {
        ...
        this.listener = new CetereumListenerAdapter();
    ...
    public BlockchainImpl withCetereumListener(CetereumListener listener) {
...
//            repository.dumpState(block, totalGasUsed, 0, null);
    ...
    public synchronized Block getBestBlock() {
        // the mcetod is synchronized since the bestBlock might be
