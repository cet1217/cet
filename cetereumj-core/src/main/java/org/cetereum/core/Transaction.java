...
import static org.cetereum.util.ByteUtil.ZERO_BYTE_ARRAY;
...
import org.cetereum.crypto.ECKey.ECDSASignature;
import org.cetereum.crypto.ECKey.MissingPrivateKeyException;
import org.cetereum.crypto.HashUtil;
import org.cetereum.datasource.MemSizeEstimator;
import org.cetereum.util.ByteUtil;
import org.cetereum.util.RLP;
import org.cetereum.util.RLPElement;
import org.cetereum.util.RLPItem;
 ...
 * signed instruction sent by an actor external to Cetereum.
...
public class Transaction {
    ...
    /* the amount of ceter to transfer (calculated as wei) */
    private byte[] value;
    ...
    /* the amount of ceter to pay as a transaction fee
    ...
    /**
     * @deprecated should prefer #sign(ECKey) over this mcetod
     */
