...
import org.cetereum.crypto.jce.ECKeyAgreement;
import org.cetereum.crypto.jce.ECKeyFactory;
import org.cetereum.crypto.jce.ECKeyPairGenerator;
import org.cetereum.crypto.jce.ECSignatureFactory;
import org.cetereum.crypto.jce.SpongyCastleProvider;
...
import static org.cetereum.util.BIUtil.isLessThan;
import static org.cetereum.util.ByteUtil.bigIntegerToBytes;
import static org.cetereum.util.ByteUtil.toHexString;

/**
 * <p>Represents an elliptic curve public and (optionally) private key, usable for digital signatures but not encryption.
 * Creating a new ECKey with the empty constructor will generate a new random keypair. Other static mcetods can be used
 ...
 *
 * This code is borrowed from the bitcoinj project and altered to fit Cetereum.<br>
...
public class ECKey implements Serializable {
    ...
    /**
     * The parameters of the secp256k1 curve that Cetereum uses.
     */
    ...
    static {
        // All clients must agree on the curve to use by agreement. Cetereum uses secp256k1.
    ...
    /**
     * Returns whceter this key is using the compressed form or not. Compressed pubkeys are only 33 bytes, not 64.
     *
     *
     * @return  -
     */
     ...
     * how ECDSA signatures are represented when embedded in other data structures in the Cetereum protocol. The raw
    ...
    public static class ECDSASignature {
         ...
         * the same message. However, we dislike the ability to modify the bits of a Cetereum transaction after it's
     ...
     * @param signatureBase64 The Cetereum-format message signature in base64
     *
     * @return -
     ...
     * expecting.</p>
     *
     * <p>If this mcetod returns null it means recovery was not possible and recId should be iterated.</p>
     *
     * <p>Given the above two points, a correct usage of this mcetod is inside a for loop from 0 to 3, and if the
