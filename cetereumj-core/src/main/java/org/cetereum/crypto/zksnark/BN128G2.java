...
import static org.cetereum.crypto.zksnark.Params.R;
import static org.cetereum.crypto.zksnark.Params.TWIST_MUL_BY_P_X;
import static org.cetereum.crypto.zksnark.Params.TWIST_MUL_BY_P_Y;
...
public class BN128G2 extends BN128Fp2 {
    ...
    /**
     * Checks whceter provided data are coordinates of a point belonging to subgroup,
    ...
    public static BN128G2 create(byte[] a, byte[] b, byte[] c, byte[] d) {
        ...
        // check whceter point is a subgroup member
