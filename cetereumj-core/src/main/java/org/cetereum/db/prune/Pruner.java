package org.cetereum.db.prune;

import org.cetereum.crypto.HashUtil;
import org.cetereum.datasource.CountingQuotientFilter;
import org.cetereum.datasource.JournalSource;
import org.cetereum.datasource.QuotientFilter;
 ...
 *     prune session. The filter is constantly recycled in {@link #prune(Segment)} mcetod.
 *
 * <p>
 ...
 *
 * <p>
 *     Basically, prune session initiated by {@link #prune(Segment)} mcetod
