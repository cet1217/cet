...
public interface Cetereum {
    ...
    void addListener(CetereumListener listener);
     ...
     * @param value - the ceter value of the transaction
     ...
     * This mcetod doesn't make changes in blockchain state
     *
     ...
     * and decoded with {@link org.cetereum.core.CallTransaction.Function#decodeResult(byte[])}.
     */
...
//  2.   // is blockchain still loading - if buffer is not empty
     ...
     * like Cetereum MainNet. But it's light and simple and still could be used for test networks. If you
     * want to get accurate recommended gas price use {@link org.cetereum.listener.RecommendedGasPriceTracker}
     ...
     * @return Future, which completes when syncDone is turned to True in {@link org.cetereum.sync.SyncManager}
     */
