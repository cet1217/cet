...
import static org.cetereum.sync.BlockDownloader.MAX_IN_REQUEST;

/**
 * Class capable of replaying stored blocks prior to 'going online' and
 * notifying on newly imported blocks
 *
 * All other CetereumListener events are just forwarded to the supplied listener.
 *
 * For example of usage, look at {@link org.cetereum.samples.EventListenerSample}
 *
 * Created by Anton Nashatyrev on 18.07.2016.
 */
public class BlockReplay extends CetereumListenerAdapter {
    ...
    public BlockReplay(BlockStore blockStore, TransactionStore transactionStore, CetereumListener listener, long firstBlock) {
    ...
    public void onCetStatusUpdated(Channel channel, StatusMessage statusMessage) {
        listener.onCetStatusUpdated(channel, statusMessage);
    }
