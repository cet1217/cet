...
import org.cetereum.mine.MinerIfc.MiningResult;
...
public class BlockMiner {
    ...
    private CompositeCetereumListener listener;
    ...
    @Autowired
    public BlockMiner(final SystemProperties config, final CompositeCetereumListener listener,
    ...
    protected void blockMined(Block newBlock) throws InterruptedException {
        ...
        ImportResult importResult = ((CetereumImpl) cetereum).addNewMinedBlock(newBlock);
