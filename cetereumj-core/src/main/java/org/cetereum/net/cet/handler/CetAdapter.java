...
/**
 * It's quite annoying to always check {@code if (cet != null)} before accessing it. <br>
 *
 * This adapter helps to avoid such checks. It provides meaningful answers to Cet client
 * assuming that Cet hasn't been initialized yet. <br>
 *
 * Check {@link org.cetereum.net.server.Channel} for example.
 *
 * @author Mikhail Kalinin
 * @since 20.08.2015
 */
public class CetAdapter implements Cet {
