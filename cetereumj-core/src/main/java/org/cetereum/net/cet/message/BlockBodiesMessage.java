...
/**
 * Wrapper around an Cetereum BlockBodies message on the network
 *
 * @see CetMessageCodes#BLOCK_BODIES
 *
 * @author Mikhail Kalinin
 * @since 04.09.2015
 */
public class BlockBodiesMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.BLOCK_BODIES;
    }
