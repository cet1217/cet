...
/**
 * Wrapper around an Cetereum BlockHeaders message on the network
 *
 * @see CetMessageCodes#BLOCK_HEADERS
 *
 * @author Mikhail Kalinin
 * @since 04.09.2015
 */
public class BlockHeadersMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.BLOCK_HEADERS;
    }
