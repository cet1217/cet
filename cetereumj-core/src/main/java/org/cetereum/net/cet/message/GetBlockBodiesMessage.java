...
/**
 * Wrapper around an Cetereum GetBlockBodies message on the network
 *
 * @see CetMessageCodes#GET_BLOCK_BODIES
 *
 * @author Mikhail Kalinin
 * @since 04.09.2015
 */
public class GetBlockBodiesMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.GET_BLOCK_BODIES;
    }
