...
/**
 * Wrapper around an Cetereum GetBlockHeaders message on the network
 *
 * @see CetMessageCodes#GET_BLOCK_HEADERS
 *
 * @author Mikhail Kalinin
 * @since 04.09.2015
 */
public class GetBlockHeadersMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.GET_BLOCK_HEADERS;
    }
