...
/**
 * Wrapper around an Cetereum NewBlockHashes message on the network<br>
 *
 * @see CetMessageCodes#NEW_BLOCK_HASHES
 *
 * @author Mikhail Kalinin
 * @since 05.09.2015
 */
public class NewBlockHashesMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.NEW_BLOCK_HASHES;
    }
