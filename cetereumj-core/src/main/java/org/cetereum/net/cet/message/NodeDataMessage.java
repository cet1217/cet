...
/**
 * Wrapper around an Cetereum NodeData message on the network
 *
 * @see CetMessageCodes#NODE_DATA
 */
public class NodeDataMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.NODE_DATA;
    }
