...
/**
 * Wrapper around an Cetereum Receipts message on the network
 * Tx Receipts grouped by blocks
 *
 * @see CetMessageCodes#RECEIPTS
 */
public class ReceiptsMessage extends CetMessage {
    ...
    public CetMessageCodes getCommand() {
        return CetMessageCodes.RECEIPTS;
    }
