...
import static org.cetereum.net.message.ReasonCode.REQUESTED;
import static org.cetereum.net.message.ReasonCode.UNKNOWN;
import static org.cetereum.net.p2p.P2pMessageCodes.DISCONNECT;

/**
 * Wrapper around an Cetereum Disconnect message on the network
 *
 * @see org.cetereum.net.p2p.P2pMessageCodes#DISCONNECT
 */
