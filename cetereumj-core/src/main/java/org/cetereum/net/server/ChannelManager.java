...
import org.cetereum.config.NodeFilter;
...
import static org.cetereum.net.message.ReasonCode.DUPLICATE_PEER;
import static org.cetereum.net.message.ReasonCode.TOO_MANY_PEERS;
...
public class ChannelManager {
    ...
    /**
     * Whceter peer with the same ip is in newPeers, waiting for processing
    ...
    /**
     * Checks whceter newPeers is not full
