...
public class PeerServer {
    ...
    public CetereumChannelInitializer cetereumChannelInitializer;
    ...
    public PeerServer(final SystemProperties config, final ApplicationContext ctx,
                      final CetereumListener cetereumListener) {
        this.ctx = ctx;
        this.config = config;
    ...
    public void start(int port) {
        ...
        cetereumChannelInitializer = ctx.getBean(CetereumChannelInitializer.class, "");

        cetereumListener.trace("Listening on port " + port);
        ...
        try {
            ...
            b.childHandler(cetereumChannelInitializer);
