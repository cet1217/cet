...
import org.cetereum.net.rlpx.discover.table.NodeEntry;
import org.cetereum.net.rlpx.discover.table.NodeTable;
import org.cetereum.net.swarm.bzz.BzzPeersMessage;
import org.cetereum.net.swarm.bzz.BzzProtocol;
import org.cetereum.net.swarm.bzz.PeerAddress;
...
public class Hive {
     ...
     *  ({@link org.cetereum.net.swarm.Hive.HiveTask#expireTime} and a limited number of
     *  peers to process ({@link org.cetereum.net.swarm.Hive.HiveTask#maxPeers}).
     *  Until the task is alive and new Peer(s) is discovered by the Hive this task
     *  is invoked with another one closest Peer.
     *  This task may complete synchronously (i.e. before the mcetod return) if the
