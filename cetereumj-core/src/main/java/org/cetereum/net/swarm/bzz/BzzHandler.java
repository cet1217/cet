...
import org.cetereum.net.swarm.NetStore;
...
public class BzzHandler extends SimpleChannelInboundHandler<BzzMessage>
    ...
    public void channelRead0(final ChannelHandlerContext ctx, BzzMessage msg) throws InterruptedException {
        ...
        cetereumListener.trace(String.format("BzzHandler invoke: [%s]", msg.getCommand()));
    ...
    public void activate() {
        ...
        cetereumListener.trace("BZZ protocol activated");
        createBzzProtocol();
        this.active = true;
    }
