...
public class CopyOnWriteMap<K, V> implements Map<K, V>, Cloneable {
    ...
    // 
    //  Below are mcetods that do not modify 
    //          the internal Maps            
    /**
    ...
    /**
     * This mcetod will return a read-only {@link Set}.
     */
    public Set<K> keySet() {
    ...
    /**
     * This mcetod will return a read-only {@link Collection}.
     */
