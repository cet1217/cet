 ...
 * RLP is the main encoding mcetod used to serialize objects in Cetereum. The
 ...
 * Cetereum the standard is that integers are represented in big endian binary
 ...
 * <p>
 * See: https://github.com/cetereum/wiki/wiki/%5BEnglish%5D-RLP
 *
...
public class RLP {
    ...
    public static int decodeInt(byte[] data, int index) {
        ...
        int value = 0;
        // NOTE: From RLP doc:
        // Cetereum integers must be represented in big endian binary form
     ...
     * you could use this mcetod to unpack them,
