...
public interface EasyBlockchain {
     ...
     */
    void sendCeter(byte[] toAddress, BigInteger weis);
     ...
     * mcetod should be used. This mcetod will generate exception in this case
     */
    ...
    /**
     * The same as the previous mcetod with specification of the exact contract
