...
import org.cetereum.config.blockchain.ByzantiumConfig;
...
import org.cetereum.config.blockchain.PetersburgConfig;
...
import org.cetereum.solidity.compiler.CompilationResult.ContractMetadata;
...
//        }
    ...
    @Override
    public void sendCeter(byte[] toAddress, BigInteger weis) {
    ...
    public BlockchainImpl getBlockchain() {
        if (blockchain == null) {
            ...
            addCetereumListener(new CetereumListenerAdapter() {
                @Override
    ...
    public void addCetereumListener(CetereumListener listener) {
        getBlockchain();
    ...
    private BlockchainImpl createBlockchain(Genesis genesis) {
        ...
        listener = new CompositeCetereumListener();

        BlockchainImpl blockchain = new BlockchainImpl(blockStore, repository)
                .withCetereumListener(listener)
