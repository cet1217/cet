...
import org.cetereum.crypto.zksnark.*;
import org.cetereum.util.BIUtil;

import java.math.BigInteger;

import static org.cetereum.util.BIUtil.addSafely;
import static org.cetereum.util.BIUtil.isLessThan;
import static org.cetereum.util.BIUtil.isZero;
...
public class PrecompiledContracts {
    ...
    public static class BN128Addition extends PrecompiledContract {
        ...
        public Pair<Boolean, byte[]> execute(byte[] data) {
            ...
            BN128<Fp> res = p1.add(p2).toCetNotation();
    ...
    public static class BN128Multiplication extends PrecompiledContract {
        ...
        public Pair<Boolean, byte[]> execute(byte[] data) {
            ...
            BN128<Fp> res = p.mul(BIUtil.toBI(s)).toCetNotation();
