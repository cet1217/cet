...
import org.cetereum.vm.program.Stack;
...
import static org.cetereum.vm.OpCode.*;
import static org.cetereum.vm.VMUtils.getSizeInWords;

/**
 * The Cetereum Virtual Machine (EVM) is responsible for initialization
...
public class VM {
    ...
    /**
     * Validates whceter operation is allowed
    ...
    /**
     * @deprecated Define your hook component as a Spring bean, instead of this mcetod using.
     * TODO: Remove after a few versions
     */
    @Deprecated
    public static void setVmHook(VMHook vmHook) {
        logger.warn("VM.setVmHook(VMHook vmHook) is deprecated mcetod. Define your hook component as a Spring bean.");
