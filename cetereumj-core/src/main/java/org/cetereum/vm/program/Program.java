 ...
 */
package org.cetereum.vm.program;
...
import org.cetereum.vm.*;
import org.cetereum.vm.PrecompiledContracts.PrecompiledContract;
import org.cetereum.vm.hook.VMHook;
import org.cetereum.vm.program.invoke.ProgramInvoke;
import org.cetereum.vm.program.invoke.ProgramInvokeFactory;
import org.cetereum.vm.program.invoke.ProgramInvokeFactoryImpl;
import org.cetereum.vm.program.listener.CompositeProgramListener;
import org.cetereum.vm.program.listener.ProgramListenerAware;
import org.cetereum.vm.program.listener.ProgramStorageChangeListener;
import org.cetereum.vm.trace.ProgramTraceListener;
import org.cetereum.vm.trace.ProgramTrace;
...
import static org.cetereum.util.BIUtil.*;
...
public class Program {
     ...
     * cetereumj may need to be started with a JVM argument to increase
    ...
    /**
     * Last Op can only be set publicly (no getLastOp mcetod), is used for logging.
     */
     ...
     */
    @SuppressWarnings("ThrowableResultOfMcetodCallIgnored")
    ...
    /**
     * That mcetod is for internal code invocations
     * <p/>
     ...
     * For more info check EIP-1283 https://eips.cetereum.org/EIPS/eip-1283
    ...
    /**
     * Denotes problem when executing Cetereum bytecode.
