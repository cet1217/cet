...
import static org.cetereum.config.Initializer.DatabaseVersionHandler.Behavior;
import static org.cetereum.config.Initializer.DatabaseVersionHandler.Behavior.*;
...
public class InitializerTest {
    ...
    @Test
    public void helper_shouldPrintCapabilityCetVersion_whenInfoEnabled() {
        ...
        try {
            ...
            assertContainsLogLine(inMemoryAppender.list, "capability cet version: [62, 63]");
    ...
    @SuppressWarnings("ResultOfMcetodCallIgnored")
