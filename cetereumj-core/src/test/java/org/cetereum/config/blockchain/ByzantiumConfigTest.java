...
public class ByzantiumConfigTest {
    ...
    @Test
    public void testCeterscanIoBlock4490790() throws Exception {
        ByzantiumConfig byzantiumConfig = new ByzantiumConfig(new TestBlockchainConfig());

        // https://ceterscan.io/block/4490788
        ...
        // https://ceterscan.io/block/4490789
        ...
        BigInteger actualDifficultyOnCeterscan = BlockHeaderBuilder.parse("1,377,927,933,620,791");
        assertTrue(actualDifficultyOnCeterscan.compareTo(minimumDifficulty) > -1);
    }
