...
import org.cetereum.mine.Cetash;
import org.cetereum.util.ByteUtil;
import org.cetereum.util.blockchain.SolidityContract;
import org.cetereum.util.blockchain.StandaloneBlockchain;
import org.cetereum.validator.DependentBlockHeaderRuleAdapter;
import org.cetereum.vm.LogInfo;
import org.cetereum.vm.program.invoke.ProgramInvokeFactoryImpl;
import org.junit.*;
...
public class ImportLightTest {
    ...
    public void importBlocks() throws Exception {
        ...
        try (Scanner scanner = new Scanner(new FileInputStream("D:\\ws\\cetereumj\\work\\blocks-rec.dmp"))) {
    ...
    public void simpleRebranch() {
        ...
        sb.sendCeter(addr1.getAddress(), BigInteger.valueOf(100));
        Block b1 = sb.createBlock();
        sb.sendCeter(addr1.getAddress(), BigInteger.valueOf(100));
        ...
        sb.sendCeter(addr1.getAddress(), BigInteger.valueOf(200));
...
//        Assert.assertEquals(bal2, bal2_);
    ...
    public void createFork() throws Exception {
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b1.getNumber()).mineLight(b1).get();
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b2.getNumber()).mineLight(b2).get();
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b3.getNumber()).mineLight(b3).get();
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b2_.getNumber()).mineLight(b2_).get();
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b3_.getNumber()).mineLight(b3_).get();
    ...
    public void invalidBlockTest() throws Exception {
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b1bad.getNumber()).mineLight(b1bad).get();
    ...
    public void doubleTransactionTest() throws Exception {
        ...
        Cetash.getForBlock(SystemProperties.getDefault(), b2f.getNumber()).mineLight(b2f).get();
    ...
    public void createValueTest() throws IOException, InterruptedException {
        ...
        bc.sendCeter(a.getAddress(), BigInteger.valueOf(10_000));
    ...
    public void operateNotExistingContractTest() throws IOException, InterruptedException {
        ...
        String contractA =
                ...
                "  }" +
                "  function callMcetod() returns (uint) {" +
                "    address addr = 0x" + Hex.toHexString(addr) + ";" +
                "    B b = B(addr);" +
                "    b.dummy();" +
                "  }" +
    ...
    public void spendGasSimpleTest() throws IOException, InterruptedException {
        ...
        bc.sendCeter(new byte[20], BigInteger.ZERO);
        bc.createBlock();
...
//                    bc.getPendingState().addPendingTransaction(callTx);
        ...
        while(cnt++ > 0) {
            ...
            bc.sendCeter(new byte[32], BigInteger.ONE);
...
//        System.out.println(Hex.toHexString(b2_.getHash()));
    ...
    public void suicideInFailedCall() throws Exception {
        ...
        bc.addCetereumListener(new CetereumListenerAdapter() {
            @Override
    ...
    public static BlockchainImpl createBlockchain(Genesis genesis) {
        ...
        CetereumListenerAdapter listener = new CetereumListenerAdapter();
