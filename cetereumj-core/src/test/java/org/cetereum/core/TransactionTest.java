...
import org.cetereum.jsontestsuite.suite.StateTestSuite;
import org.cetereum.jsontestsuite.suite.runners.StateTestRunner;
...
import static org.cetereum.solidity.SolidityType.*;
...
public class TransactionTest {
    ...
    // Testdata from: https://github.com/cetereum/tests/blob/master/txtest.json
...
//        Transaction tx = new Transaction(Hex.decode(rlp));
        ...
        */
        ...
        List<String> res = new StateTestRunner(stateTestSuite.getTestCases().get("test1")) {
            ...
            protected ProgramResult executeTransaction(Transaction tx) {
                // first emulating the constant call (Cetereum.callConstantFunction)
    ...
    public void homesteadContractCreationTest() throws Exception {
        ...
        // https://github.com/cetereum/EIPs/blob/master/EIPS/eip-2.mediawiki
