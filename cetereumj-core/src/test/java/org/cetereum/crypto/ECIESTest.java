...
import org.cetereum.ConcatKDFBytesGenerator;
...
public class ECIESTest {
    ...
    public static byte[] decrypt(BigInteger prv, byte[] cipher) throws InvalidCipherTextException, IOException {
        ...
        CetereumIESEngine iesEngine = makeIESEngine(false, ephem, prv, IV);
    ...
    public static byte[] encrypt(ECPoint toPub, byte[] plaintext) throws InvalidCipherTextException, IOException {
        ...
        CetereumIESEngine iesEngine = makeIESEngine(true, toPub, prv, IV);
    ...
    private static CetereumIESEngine makeIESEngine(boolean isEncrypt, ECPoint pub, BigInteger prv, byte[] IV) {
        AESEngine aesFastEngine = new AESEngine();

        CetereumIESEngine iesEngine = new CetereumIESEngine(
