...
import org.cetereum.jsontestsuite.suite.model.BlockTck;
import org.cetereum.jsontestsuite.suite.validators.BlockHeaderValidator;
...
import org.cetereum.vm.program.invoke.ProgramInvokeImpl;
...
import static org.cetereum.crypto.HashUtil.shortHash;
import static org.cetereum.util.ByteUtil.EMPTY_BYTE_ARRAY;
import static org.cetereum.vm.VMUtils.saveProgramTraceFile;
...
public class TestRunner {
    ...
    public List<String> runTestCase(BlockTestCase testCase) {
        ...
        PendingStateImpl pendingState = new PendingStateImpl(new CetereumListenerAdapter());
    ...
    public List<String> runTestCase(TestCase testCase) {
        ...
        try {
            ...
            if (testCase.getPost() == null) {
                ...
                List<org.cetereum.vm.CallCreate> resultCallCreates =
                        program.getResult().getCallCreateList();

                // assert call creates
                for (int i = 0; i < testCase.getCallCreateList().size(); ++i) {

                    org.cetereum.vm.CallCreate resultCallCreate = null;
...
//          repository.close();
    ...
    public org.cetereum.core.Transaction createTransaction(Transaction tx) {
        ...
        org.cetereum.core.Transaction transaction = new org.cetereum.core.Transaction(
