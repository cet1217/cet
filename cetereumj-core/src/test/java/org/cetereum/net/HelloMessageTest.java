...
public class HelloMessageTest {
    ...
    public void test1() {
        ...
        assertEquals("Cetereum(++)/v0.7.9/Release/Linux/g++", helloMessage.getClientId());
    ...
    public void test2() {
        ...
        //Init
        byte version = 2;
        String clientStr = "Cetereum(++)/v0.7.9/Release/Linux/g++";
        List<Capability> capabilities = Arrays.asList(
                new Capability(Capability.CET, CetVersion.UPPER),
