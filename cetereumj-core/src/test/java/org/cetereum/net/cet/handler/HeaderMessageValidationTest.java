...
import org.cetereum.net.cet.message.BlockHeadersMessage;
...
/**
 * Testing {@link org.cetereum.net.cet.handler.Cet62#isValid(BlockHeadersMessage, GetBlockHeadersMessageWrapper)}
 */
public class HeaderMessageValidationTest {

    private byte[] EMPTY_ARRAY = new byte[0];

    private class Cet62Tester extends Cet62 {
    ...
    private Cet62Tester cetHandler;

    public HeaderMessageValidationTest() {
        cetHandler = new Cet62Tester();
    }
    ...
    public void testSingleBlockResponse() {
        ...
        assert cetHandler.blockHeaderMessageValid(msg, wrapperHash);
        ...
        assert cetHandler.blockHeaderMessageValid(msg, wrapperNumber);
        ...
        assert cetHandler.blockHeaderMessageValid(msg, wrapperReverse);
        ...
        assert cetHandler.blockHeaderMessageValid(msg, wrapperSkip);
    }
    ...
    public void testFewBlocksWithSkip() {
        ...
        assert cetHandler.blockHeaderMessageValid(msg, wrapperMore);
