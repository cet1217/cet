...
import org.cetereum.net.cet.message.GetBlockBodiesMessage;
...
/**
 * Testing whceter Cet handler {@link Cet62} is blocking {@link BlockchainImpl}
 */
public class LockBlockchainTest {
    ...
    public LockBlockchainTest() {
        ...
        SysPropConfig1.testHandler = new Cet62(SysPropConfig1.props, blockchain, blockStoreDummy,
                new CompositeCetereumListener()) {
            {
                this.blockstore = blockStoreDummy;
