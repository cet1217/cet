...
/**
 * Testing {@link Cet62#processNewBlockHashes(NewBlockHashesMessage)}
 */
public class ProcessNewBlockHashesTest {
    ...
    public void testSingleHashHandling() {
        ...
        cetHandler.setGetNewBlockHeadersParams(blockHash, 1, 0, false);
        cetHandler.processNewBlockHashes(msg);
        assert cetHandler.wasCalled;
    }
    ...
    public void testSeveralHashesHandling() {
        ...
        cetHandler.setGetNewBlockHeadersParams(blockHash1, 3, 0, false);
        cetHandler.processNewBlockHashes(msg);
        assert cetHandler.wasCalled;
    }
    ...
    public void testSeveralHashesMixedOrderHandling() {
        ...
        cetHandler.setGetNewBlockHeadersParams(blockHash2, 3, 0, false);
        cetHandler.processNewBlockHashes(msg);
        assert cetHandler.wasCalled;
    }
}
