...
import static org.cetereum.util.RLP.*;
import static org.junit.Assert.*;
import static org.cetereum.util.RlpTestData.*;
...
public class RLPTest {
    ...
    public void test7() {
        ...
        String test = "CetereumJ Client";
        data = encodeString(test);

        assertArrayEquals(expected, data);

        String test2 = "Cetereum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++";
        ...
        String test3 = "Cetereum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++Cetereum(++)/ZeroGox/v0.5.0/ncurses/Linux/g++";
...
//        2240089100000070
    ...
    /************************************
     * Test data from: https://github.com/cetereum/wiki/wiki/%5BEnglish%5D-RLP
     *
    ...
    @Test // capabilities: (cet:60, bzz:0, shh:2)
    public void testEncodeHelloMessageCap0(){

        List<Capability> capabilities = new ArrayList<>();
        capabilities.add(new Capability("cet", (byte) 0x60));
        ...
        HelloMessage helloMessage = new HelloMessage((byte)4,
                "Gcet/v0.9.29-4182e20e/windows/go1.4.2",
                capabilities , 30303,
        ...
        String cet    = helloMessage_.getCapabilities().get(0).getName();
        byte   cet_60 = helloMessage_.getCapabilities().get(0).getVersion();

        assertEquals("cet", cet);
        assertEquals(0x60, cet_60);
